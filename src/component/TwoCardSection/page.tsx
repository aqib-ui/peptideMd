    ...
    <>
      ...
      <section className="min-h-screen flex flex-col max-md:px-2  ">
        <div className="flex flex-wrap xl:flex-nowrap justify-around mt-8 p-1 md:p-6">
          ...
          <div
            className="relative w-full md:w-[65%] 2xl:w-[35.85%] h-[400px] sm:min-h-[600px] lg:h-[550px] shadow-lg overflow-hidden rounded-[3rem] md:mb-10"
            style={{ height: "clamp(550px, calc(450px + 17.52vw), 753px)" }}
          >
            <Image
              src="/card-pic.png"
              alt="Card Image"
          ...
          <div className="flex flex-col w-full 2xl:w-[55%] h-auto   rounded-[3rem] p-6 md:p-1">
            ...
            {/* List section */}
            <div
              className="flex  xl:justify-end justify-center mt-16 sm:mt-24 px-4"
              style={{ fontFamily: "Afacad, sans-serif" }}
            >
              <ul className="space-y-2 w-full max-w-[724px] ">
                {[
                  {
