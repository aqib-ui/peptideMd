...
const caseStudies = [
  {
    ...
    poster: "/Dashboard/rec-case/1.jpg",
    date: "1/May/2025",
  },
  {
    title: "Reversing Tendon Injury with BPC-157: A Healing Journey",
    poster: "/Dashboard/rec-case/2-a.jpg",
    date: "1/May/2025",
  },
  {
        ...
        {caseStudies.map((study, index) => (
          ...
          >
            ...
            <div className="flex flex-col  w-full   justify-between  max-2xl:gap-0">
              <h3 className="txt-18 leading-6 font-semibold w-full line-clamp-3 h-[76px] ">
                {study.title}
              </h3>
