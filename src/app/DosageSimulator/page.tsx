  ...
  return (
    <div className="pl-5 pr-4">
      ...
      <h2
        ...
        className=" text-[20px] md:text-[28px] lg:text-[34px] font-medium leading-[120%] mt-6 mb-2 max-w-7xl"
        style={{ fontFamily: "Afacad, sans-serif" }}
      >
        This simulator is for educational purposes only. Always consult with a qualified healthcare provider before starting any peptide therapy. Proper medical supervision is essential.
      </h2>
...
function Calculator() {
  ...
  return (
    <div className="pl-5 pr-4">
      ...
      <h2
        className="text-[20px] md:text-[28px] lg:text-[34px] font-medium leading-[120%] mt-6 mb-10 max-w-7xl"
        style={{ fontFamily: "Afacad, sans-serif" }}
      >
        This simulator is for educational purposes only. Always consult with a qualified healthcare provider before starting any peptide therapy. Proper medical supervision is essential.
      </h2>
